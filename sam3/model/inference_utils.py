...
"""
Inference-only utilities for SAM3 models.

This module contains utilities extracted from training code that are needed
for inference operations, primarily for mask encoding in RLE format.
"""
