...
def _create_sam3_model(
    ...
    # Matcher only needed for training mode - always None for inference
    if not eval_mode:
        raise ValueError(
            "Training mode (eval_mode=False) is not supported in this inference-only build. "
            "Please use eval_mode=True for inference."
        )
